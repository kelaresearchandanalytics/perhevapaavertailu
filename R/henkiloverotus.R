#' Henkilöverotus vuodelle 2026
#' 
#' Henkilön palkka-, etuus- ja eläketulon verotus vuonna 2026
#' @param aineisto data-frame
#' @param ika henkilön ikä vuoden lopussa
#' @param lapsi_lkm_yksin yksin huollettavien lasten lukumäärä
#' @param lapsi_lkm_yhteis yhteishuollettavien lasten lukumäärä
...
#' aineisto<-data.frame(
#' ika = sample(seq(16,70),n,replace=TRUE),
#' lapsi_lkm_yksin = sample(c(0,1),n,replace=TRUE),
#' lapsi_lkm_yhteis = sample(c(0,1),n,replace=TRUE),
...
#' tmp2 <- henkiloverotus_2026(aineisto,ika,lapsi_lkm_yksin,lapsi_lkm_yhteis,
#'   kunnan_veropros,kirkko_veropros,elaketulo ,palkkatulo,etuustulo)
#' 
#' # tai vaihtoehtoisesti toimii myos pipe-operaattori
#' tmp1 <- aineisto |> henkiloverotus_2026(ika,lapsi_lkm_yksin,lapsi_lkm_yhteis,
#'   kunnan_veropros,kirkko_veropros,elaketulo,palkkatulo,etuustulo)
#' 
#' @export
#' @encoding UTF-8
henkiloverotus_2026<-function(
    aineisto,
    ika,
    lapsi_lkm_yksin,
    lapsi_lkm_yhteis,
  ...
  p_lapsi_lkm_yksin <- dplyr::enquo(lapsi_lkm_yksin)
  p_lapsi_lkm_yhteis <- dplyr::enquo(lapsi_lkm_yhteis)
  ...
  # ¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨
  # Työelakemaksut
  p_tyel_alaikaraja <- 17
  p_tyel_ikaraja_1 <- 53 
  p_tyel_ikaraja_2 <- 62 + 1 # Työkirjalla ikaraja ilmaistu eritavoin
  p_tyel_ylaikaraja <- 68 
  # Työelakemaksut (alaikaraja - ikaraja_1 ja ikaraja_2 - ylaikaraja)
  p_tyel_pros_1 <- 0.0730 # TyELp1
  # Työelakemaksut (ikaraja_1 - ikaraja_2)
  p_tyel_pros_2 <- 0.0730 # TyELp2
  
  # Työttömyysvakuutusmaksu
  p_tyotvak_alaikaraja <- 18 # TV_alaikär
  p_tyotvak_ylaikaraja <- 64 # TVikär
  p_tyotvak_pros <- 0.0089 # TVp 
  
  # Paivarahamaksu
  p_paivarahamaksun_alaikaraja <- 16 # PVR_ikäraja  # HUOM! uuusi
  p_paivarahamaksun_ylaikaraja <- 68 # PVR_ikäraja  # HUOM! uuusi
  p_paivaraha_pros_1_raja <- 17255 # PVRr
  p_paivaraha_pros_1 <- 0 # PVRp1
  p_paivaraha_pros_2 <- 0.0088 # PVRp2
  
  #p_paivarahamaksun_ikaraja <- 68 # PVR_ikäraja
  
  # Sairaanhoitomaksun korotus
  p_sairaanhoitomaksu_korotus_ikaraja <- 68 # PVR_ikäraja
  p_sairaanhoitomaksu_korotus <-  0.0149 # SH_korp
  p_sairaanhoitomaksu_korotus_1 <- 0.0039 # SH_lisap
  
  # Sairaanhoitomaksu
  p_sairhoito_pros <- 0.011 # SH_p
  
  # YLE-vero
  p_yle_alaikaraja <- 18 # HUOM! uuusi
  p_yle_ansioraja <- 15150 # YLEr
  p_yle_max <- 160 # YLEmax
  ...
  p_elak_lisa_raja <- 60000 # VETlisar
  ...
  p_valtionvero_raja_2 <- 22000 # valtr2
  p_valtionvero_pros_3 <- 0.3025 # valtp3
  p_valtionvero_raja_3 <- 32600 # valtr3
  p_valtionvero_pros_4 <- 0.3325 # valtp4
  p_valtionvero_raja_4 <- 40100 # valtr4
  p_valtionvero_pros_5 <- 0.3750 # valtp5
  p_valtionvero_raja_5 <- 52100 # valtr5
  p_valtionvero_pros_6 <- 0.3750 # valtp6
  p_valtionvero_raja_6 <- 150000 # valtr6
  
  # Työtulovahennys
  # ¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨ 
  p_tyotulo_vah_max <- 3430 # TTvahmax
  
  p_tyotulo_vah_enimm_ika1 <- 60 # TTvahikar1
  p_tyotulo_vah_enimm_ika2 <- 62 # TTvahikar2
  p_tyotulo_vah_enimm_ika3 <- 65 # TTvahikar3
  
  p_tyotulo_vah_enimm1 <- 3430 # TTvahmax1
  p_tyotulo_vah_enimm2 <- 3430 # TTvahmax2
  p_tyotulo_vah_enimm3 <- 4630 # TTvahmax3
  
  p_tyotulo_vah_pros_1 <- 0.1800 # TTvahp1
  p_tyotulo_vah_pien_2 <- 0.0200 # TTvahp2
  p_tyotulo_vah_pien_3 <- 0.0000 # TTvahp3
  
  p_tyotulo_tuloraja_1 <- 0 # TTvahr1
  p_tyotulo_tuloraja_2 <- 35000 # TTvahr2
  p_tyotulo_tuloraja_3 <- 50550 # TTvahr3
  
  p_tyotulo_lapsivahennys <- 105 # TTlapvah
  ...
  dplyr::mutate(aineisto,
                ...
                tyoelakemaksu = dplyr::case_when(
                  !!p_ika < p_tyel_alaikaraja ~ 0,
                  !!p_ika < p_tyel_ikaraja_1 ~ viitospyoristys(p_tyel_pros_1 * !!p_palkkatulo, p_pyoristys2),
                  !!p_ika < p_tyel_ikaraja_2 ~ viitospyoristys(p_tyel_pros_2 * !!p_palkkatulo, p_pyoristys2),
                  !!p_ika < p_tyel_ylaikaraja ~ viitospyoristys(p_tyel_pros_1 * !!p_palkkatulo, p_pyoristys2),
                  !!p_ika >= p_tyel_ylaikaraja ~ 0
                ),
                # Työttömyysvakuutusmaksu
                ...
                # Paivarahamaksu
                #DEBUG: =JOS(JA(A12>=PVR_alaikä;A12<PVR_yläikä);JOS(G12<PVRr;0*G12;PVRp2*G12);0)
                paivarahamaksu = viitospyoristys(
                  ifelse( !!p_ika >= p_paivarahamaksun_alaikaraja & !!p_ika < p_paivarahamaksun_ylaikaraja,
                ...
                # Työtulovähennys
                # ¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨
                # DEBUG:=JOS(G12>0;MIN(TTvahp1*G12;JOS(A12<TTvahikar3;TTvahmax;TTvahmax3)+(C12*TTlapvah+B12*TTlapvah*2));0)
                tyotulo_max_vah = viitospyoristys(
                  ifelse(!!p_palkkatulo > 0, pmin(p_tyotulo_vah_pros_1 * !!p_palkkatulo, ifelse( !!p_ika < p_tyotulo_vah_enimm_ika3, p_tyotulo_vah_max, p_tyotulo_vah_enimm3) + p_tyotulo_lapsivahennys * (!!p_lapsi_lkm_yhteis + !!p_lapsi_lkm_yksin * 2)),0)
                  , p_pyoristys2),
...
#' Henkilöverotus vuodelle 2025
#' 
#' Henkilön palkka-, etuus- ja eläketulon verotus vuonna 2025
#' @param aineisto data-frame
#' @param ika henkilön ikä vuoden lopussa
#' @param lapsi_lkm_yksin yksin huollettavien lasten lukumäärä
#' @param lapsi_lkm_yhteis yhteishuollettavien lasten lukumäärä
...
#' 
#' # aineiston voi valitaa parametrina
#' tmp2 <- henkiloverotus_2025(aineisto,ika,lapsi_lkm_yksin,lapsi_lkm_yhteis,
#'   kunnan_veropros,kirkko_veropros,elaketulo ,palkkatulo,etuustulo)
#' 
#' # tai vaihtoehtoisesti toimii myos pipe-operaattori
#' tmp1 <- aineisto |> henkiloverotus_2025(ika,lapsi_lkm_yksin,lapsi_lkm_yhteis,
#'   kunnan_veropros,kirkko_veropros,elaketulo,palkkatulo,etuustulo)
#' 
#' @export
#' @encoding UTF-8
henkiloverotus_2025<-function(
    aineisto,
    ika,
    lapsi_lkm_yksin,
    lapsi_lkm_yhteis,
  ...
  p_tyel_ylaikaraja <- 68 
  # Työelakemaksut (alaikaraja - ikaraja_1 ja ikaraja_2 - ylaikaraja)
  p_tyel_pros_1 <- 0.0715 # TyELp1
  # Työelakemaksut (ikaraja_1 - ikaraja_2)
  p_tyel_pros_2 <- 0.0865 # TyELp2
  
  # Työttömyysvakuutusmaksu
  p_tyotvak_pros <- 0.0059 # TVp 
  p_tyotvak_alaikaraja <- 18 # TV_alaikär
  p_tyotvak_ylaikaraja <- 64 # TVikär
  
  # Paivarahamaksu
  p_paivaraha_pros_1_raja <- 16862 # PVRr
  p_paivaraha_pros_1 <- 0 # PVRp1
  p_paivaraha_pros_2 <- 0.0084 # PVRp2
  p_paivarahamaksun_alaikaraja <- 16 # PVR_ikäraja  # HUOM! uuusi
  p_paivarahamaksun_ylaikaraja <- 68 # PVR_ikäraja  # HUOM! uuusi
  ...
  # Sairaanhoitomaksun korotus
  p_sairaanhoitomaksu_korotus_ikaraja <- 68 # PVR_ikäraja
  p_sairaanhoitomaksu_korotus <-  0.0145 # SH_korp
  p_sairaanhoitomaksu_korotus_1 <- 0.0039 # SH_lisap
  
  # Sairaanhoitomaksu
  p_sairhoito_pros <- 0.0106 # SH_p
  ...
  p_valtionvero_raja_1 <- 0 # valtr1
  p_valtionvero_pros_2 <- 0.19 # valtp2
  p_valtionvero_raja_2 <- 21200 # valtr2
  p_valtionvero_pros_3 <- 0.3025 # valtp3
  p_valtionvero_raja_3 <- 31500 # valtr3
  p_valtionvero_pros_4 <- 0.34 # valtp4
  p_valtionvero_raja_4 <- 52100 # valtr4
  p_valtionvero_pros_5 <- 0.4175 # valtp5
  p_valtionvero_raja_5 <- 88200 # valtr5
  p_valtionvero_pros_6 <- 0.4425 # valtp6
  p_valtionvero_raja_6 <- 150000 # valtr6
  
  # Työtulovahennys
  # ¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨ 
  p_tyotulo_vah_max <- 3225 # TTvahmax
  
  p_tyotulo_vah_enimm_ika1 <- 60 # TTvahikar1
  p_tyotulo_vah_enimm_ika2 <- 62 # TTvahikar2
  p_tyotulo_vah_enimm_ika3 <- 65 # TTvahikar3
  
  p_tyotulo_vah_enimm1 <- 3225 # TTvahmax1
  p_tyotulo_vah_enimm2 <- 3225 # TTvahmax2
  p_tyotulo_vah_enimm3 <- 4425 # TTvahmax3
  
  p_tyotulo_vah_pros_1 <- 0.18 # TTvahp1
  p_tyotulo_vah_pien_2 <- 0.0222 # TTvahp2
  p_tyotulo_vah_pien_3 <- 0.0344 # TTvahp3
  
  p_tyotulo_tuloraja_1 <- 0 # TTvahr1
  p_tyotulo_tuloraja_2 <- 24250 # TTvahr2
  p_tyotulo_tuloraja_3 <- 42550 # TTvahr3
  
  p_tyotulo_lapsivahennys <- 50 # TTlapvah
